...
ActiveRecord::Schema.define(version: 20_210_115_014_225) do
  ...
  create_table 'eventattendances', force: :cascade do |t|
    ...
    t.datetime 'created_at', precision: 6, null: false
    t.datetime 'updated_at', precision: 6, null: false
    t.index %w[character_id event_id], name: 'index_eventattendances_on_character_id_and_event_id', unique: true
