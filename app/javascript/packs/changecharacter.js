...
function characterDetails() {
  ...
  $.ajax({
    ...
    success: function(data){
      ...
      document.getElementById('changeCharacterclasstoken').src = '/images/classtoken/' + data.all_data.characterclass.name.downcase + '.png'
      ...
      if (data.all_data.deity == null) {
        ...
        document.getElementById('changeCharacterdeitytoken').src = '/images/deitytoken/' + data.all_data.deity.name.downcase + '.gif'
